...
class MyBlogSource(private val author: String, private val blogRepository: BlogRepository) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Blog> {
        try {
            ...
            val response = blogRepository.getBlogsByAuthor(author, page, params.loadSize)
